...
def test_process_pair():
    ...
    image_1_path = PROJECT_ROOT / "assets" / "reconstruction" / "scene_10" / "camera_1.png"
    image_2_path = PROJECT_ROOT / "assets" / "reconstruction" / "scene_10" / "camera_2.png"
    ...
    with open(PROJECT_ROOT / "assets" / "reconstruction" / "scene_10" / "calibration.json", "r") as f:
