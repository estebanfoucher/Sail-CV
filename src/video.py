...
class VideoReader:
    ...
    def _calculate_fps_manually(self) -> float:
    ...
    def read(self, frame_number: Optional[int] = None) -> Tuple[bool, Optional[np.ndarray]]:
...
class StereoVideoReader:
    ...
    def __init__(self, video_1_path: str, video_2_path: str, 
                 start_video_1_frame: int = 0, start_video_2_frame: int = 0):
        self.video_1_path = video_1_path
        self.video_2_path = video_2_path
        self.video_1 = VideoReader.open_video_file(video_1_path, start_frame=start_video_1_frame)
        self.video_2 = VideoReader.open_video_file(video_2_path, start_frame=start_video_2_frame)
        
    def read(self) -> Tuple[bool, bool, Optional[np.ndarray], Optional[np.ndarray]]:
    ...
    def read_frames(self, frame_1_number: int, frame_2_number: int) -> Tuple[bool, bool, Optional[np.ndarray], Optional[np.ndarray]]:
...
class FrameExtractor:
    ...
    def extract_frames(self):
        ...
        frame_numbers = frame_numbers[frame_numbers < specs.frame_count]  # remove frames that are out of range
