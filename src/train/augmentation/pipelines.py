...
def build_augmentation_pipeline(
    *,
    ...
    transforms: list = [
        ...
        A.GaussNoise(var_limit=(8.0, 48.0), p=0.2),
        A.CoarseDropout(
            max_holes=4,
            max_height=24,
            max_width=24,
        ...
        shadow,
        A.RandomFog(fog_coef_lower=0.1, fog_coef_upper=0.35, alpha_coef=0.1, p=0.28),
        A.RandomRain(
            slant_lower=-8,
            slant_upper=8,
            drop_length=18,
        ...
        A.RandomSnow(
            brightness_coeff=2.0, snow_point_lower=0.1, snow_point_upper=0.3, p=0.15
        ),
